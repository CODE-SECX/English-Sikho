    ...
    <div className="bg-white/60 backdrop-blur-sm rounded-xl p-5 border border-slate-200/60 hover:border-slate-300/60 hover:shadow-lg transition-all duration-300 group">
      <div className="flex justify-between items-start mb-3">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="text-lg font-bold text-slate-900">{sikho.title}</h3>
      ...
      <button
        onClick={() => onView(sikho)}
        className="mt-3 text-sm text-emerald-600 hover:text-emerald-700 font-medium opacity-0 group-hover:opacity-100 transition-opacity"
      >
        View full details →
      </button>
    </div>
